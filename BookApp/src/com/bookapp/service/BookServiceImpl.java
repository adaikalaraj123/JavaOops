...
public class BookServiceImpl implements IBookService {
    ...
    public List<Book> getByAuthorContains(String author) throws BookNotFoundException {
        ...
        if (books.isEmpty()) throw new BookNotFoundException("No books found by author: " + author);
        return books;
    }
    ...
    public List<Book> getByAuthorContainsAndCategory(String author, String category) throws BookNotFoundException {
        List<Book> books = BookDetails.getBooks().stream()
                ...
                .collect(Collectors.toList());
        if (books.isEmpty()) throw new BookNotFoundException("No books found for author: " + author + " in category: " + category);
        return books;
    }
